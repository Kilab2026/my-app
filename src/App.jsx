Ersetze testweise den kompletten Inhalt von `src/App.jsx` mit diesem Debug-Code (ohne EmailJS, nur um den Button-Test zu machen):
...
<button style={{marginTop:"30px",padding:"18px 35px",fontSize:"20px",borderRadius:"12px",border:"none"}}>
